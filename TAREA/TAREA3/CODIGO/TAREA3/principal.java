...
public class principal extends javax.swing.JFrame {
    ...
    public void CambioColor() {
        Proceso hilo = new Proceso(btn1, btn2, jPanel2);
        hilo.start();
    }
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        if (btn1.getBackground() == Color.RED) {
            int aux = Integer.parseInt(txt1.getText());
            txt1.setText(String.valueOf(aux + 1));
        } else {
            int aux = Integer.parseInt(txt2.getText());
            txt2.setText(String.valueOf(aux + 1));
        }
